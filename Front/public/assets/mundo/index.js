...
image.src = 'assets/mundo/img/Pellet_Town.png'
...
foregroundImage.src = 'assets/mundo/img/foregroundObjects.png'
...
playerDownImage.src = "assets/mundo/img/playerDown.png"
const playerUpImage = new Image()
playerUpImage.src = "assets/mundo/img/playerUp.png"
const playerLeftImage = new Image()
playerLeftImage.src = "assets/mundo/img/playerLeft.png"
const playerRightImage = new Image()
playerRightImage.src = "assets/mundo/img/playerRight.png"
...
function animatePuzzle1() {
    ...
    window.location.href = 'assets/mundo/acertijos/acertijo1/acertijo1.html';
}
function animatePuzzle2() {
    window.requestAnimationFrame(animatePuzzle2);
    window.location.href = 'assets/mundo/acertijos/acertijo2/acertijo2.html';
}
function animatePuzzle3() {

    window.requestAnimationFrame(animatePuzzle3);
    window.location.href = 'assets/mundo/acertijos/acertijo3/acertijo3.html';

}
function animateTetris() {
    window.requestAnimationFrame(animateTetris);
    window.location.href = 'assets/mundo/tetris/tetris.html';
}
